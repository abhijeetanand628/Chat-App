...
function App() {
  ...
  const submitHandler = async(e) => {
    ...
    try {
      setMessage(""); // This is used to set the enter a msg field empty again after sending the msg
  ...
  useEffect(() => {
    ...
    const unsubs = onAuthStateChanged(auth,(data) => {
      setUser(data)
    });

    const unsubsForMessage = onSnapshot(q,(snap) => {
